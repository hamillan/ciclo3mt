...
var consultarRs = function () {
    $.ajax({
        url: "http://129.159.57.91:8080/api/Reservation" + "/all",
        type: 'GET',
        dataType: 'json',
        success: function (respuesta) {
...
var guardarCambiosRs = function () {
    ...
    if (id !== 'undefined' && id !== null && id.length > 0) {
        ruta = "http://129.159.57.91:8080/api/Reservation" + "/update";
        payload = {
        ...
        ruta = "http://129.159.57.91:8080/api/Reservation" + "/save";
        console.log(ruta)
        payload = {
            startDate: $("#startDate").val(),
            devolutionDate: $("#devolutionDate").val(),
...
var eliminarRs = function (idReservation) {
    ...
    $.ajax({
        url: "http://129.159.57.91:8080/api/Reservation" + "/" + idReservation,
        type: 'DELETE',
        dataType: 'json',
        headers: {
            "Content-Type": "application/json"
